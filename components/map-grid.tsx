...
// Function to get monster image name - using actual monster images for map
function getMonsterImageName(monsterType: string): string {
  ...
  return monsterImageMap[monsterType] || 'Dragoni.png';
}
                ...
                return (
                  ...
                  >
                    ...
                    {tile.hasMonster && (
                      <div className="absolute inset-0 flex items-center justify-center z-50 pointer-events-none">
                        <Image
                          src={`/images/Monsters/${getMonsterImageName(tile.hasMonster)}`}
