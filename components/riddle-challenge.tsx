...
// Classic clever riddles with answers
const riddles = [
  {
  ...
  },
  {
    ...
    options: ["A stamp", "A coin", "A shadow", "A compass"],
    answer: "A stamp",
  },
  {
