    ...
    <div className="w-full max-w-2xl space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-center">
          <div className="grid grid-cols-4 gap-1 bg-zinc-800/50 border border-amber-800/20 rounded-lg p-4">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center">
                  ...
                  <div className="text-sm text-zinc-400">Tiles Placed</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-amber-400">+{kingdomSize * 10}</div>
                  <div className="text-sm text-zinc-400">Kingdom Value</div>
                </div>
              </div>
            </div>
          </CardContent>
      ...
      {!showGrowth && (
        <div className="text-center">
          <p className="text-sm text-zinc-400">Watch your kingdom grow as tiles are placed...</p>
        </div>
      )}
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <div className="flex items-center space-x-2 text-sm">
              ...
              <span className="text-zinc-300">Unlock new quest categories</span>
            </div>
            <div className="flex items-center space-x-2 text-sm">
              <TrendingUp className="h-4 w-4 text-amber-400" />
              <span className="text-zinc-300">Earn bonus rewards</span>
            </div>
            <div className="flex items-center space-x-2 text-sm">
              <TrendingUp className="h-4 w-4 text-amber-400" />
              <span className="text-zinc-300">Access special events</span>
            </div>
          </div>
        </div>
      )}
