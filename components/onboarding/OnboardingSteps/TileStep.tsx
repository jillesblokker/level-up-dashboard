    ...
    <div className="w-full max-w-2xl space-y-6">
      ...
      <div className="text-center space-y-2">
        <div className="flex items-center justify-center space-x-2">
          <span className="text-2xl font-bold text-amber-400">{goldBalance}</span>
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-semibold text-white">Tile Inventory</h3>
            ...
            >
              <CardContent className="p-4">
                <div className="text-center space-y-3">
                  <div className="w-16 h-16 mx-auto bg-gradient-to-br from-gray-700 to-gray-800 rounded-lg flex items-center justify-center">
                    <MapIcon className="h-8 w-8 text-amber-400" />
                  </div>
                  <div>
                    <h4 className="font-medium text-white">{tile.name}</h4>
