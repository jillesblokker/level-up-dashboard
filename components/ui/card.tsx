...
>(({ className, ...props }, ref) => ( <div ref={ref} className={cn( "rounded-lg border border-amber-900/30 bg-zinc-950 text-card-foreground shadow-[0_0_15px_rgba(245,158,11,0.05)] hover:border-amber-700/50 hover:shadow-[0_0_20px_rgba(245,158,11,0.1)] transition-all duration-300", className )} {...props} />
))
