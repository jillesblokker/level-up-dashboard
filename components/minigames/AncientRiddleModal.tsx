...
export function AncientRiddleModal({ isOpen, onClose }: AncientRiddleModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(op) => { if (!op) onClose() }}>
      <DialogContent className="max-w-md w-full bg-gradient-to-b from-blue-950 via-zinc-950 to-zinc-950 border border-blue-500/40 text-blue-100 p-6 rounded-2xl shadow-2xl font-serif text-center max-h-[88dvh] overflow-y-auto custom-scrollbar">
        <DialogHeader className="px-8 sm:px-10">
          ...
          <DialogTitle className="text-2xl font-medieval text-blue-200 break-words">
