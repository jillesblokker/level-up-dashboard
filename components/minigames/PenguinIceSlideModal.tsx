...
export function PenguinIceSlideModal({ isOpen, onClose, onSuccess }: PenguinIceSlideModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => { if (!open) onClose(); }}>
      <DialogContent className="max-w-xl w-full bg-[#05111c] border border-cyan-500/30 text-cyan-50 p-4 sm:p-6 rounded-2xl shadow-2xl font-serif max-h-[95vh] overflow-y-auto">
