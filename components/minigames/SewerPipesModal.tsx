...
export function SewerPipesModal({ isOpen, onClose, onSuccess }: SewerPipesModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => { if (!open) onClose(); }}>
      <DialogContent className="max-w-xl w-full bg-[#0a0f14] border border-cyan-900/40 text-cyan-50 p-4 sm:p-6 rounded-2xl shadow-2xl font-serif max-h-[95vh] overflow-y-auto">
