...
export function MobileErrorFallback({ error, resetErrorBoundary }: MobileErrorFallbackProps) {
  return (
    <div className="min-h-screen bg-zinc-900 text-white p-6 flex flex-col items-center justify-center">
      ...
      <p className="text-zinc-300 mb-8 text-center text-lg max-w-sm">
        A mysterious error has occurred in your adventure. Don&apos;t worry, your progress is safe.
      </p>
      
      {error && (
        <div className="bg-zinc-800 rounded-lg p-4 mb-8 max-w-sm w-full">
      ...
      <div className="w-full max-w-sm space-y-4">
        ...
        <button
          ...
          className="w-full bg-zinc-700 hover:bg-zinc-600 active:bg-zinc-500 px-6 py-4 rounded-xl flex items-center justify-center gap-3 text-lg font-semibold transition-all duration-200 min-h-[56px] touch-manipulation"
        >
          🔄 Reload Page
        </button>
