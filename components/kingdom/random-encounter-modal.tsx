...
const ENCOUNTER_DATA: Record<EncounterType, EncounterData> = {
  meditation: {
    ...
    heroImg: '/images/headers/realm-header.webp',
  ...
  quest_completion: {
    ...
    subtitle: 'Queen Valandriel of Sunspire Visits',
    characterName: 'Queen Valandriel',
    characterRole: 'Monarch of Sunspire',
    avatarImg: '/images/headers/allies-header.webp',
    heroImg: '/images/headers/quests-header.webp',
    themeColor: 'from-amber-900/80 via-zinc-950 to-zinc-950 border-amber-500/40',
    badgeText: 'Royal Invitation',
    description: 'News of your rebuilt town reached the Sunspire Empire! Queen Valandriel arrives at your gates to celebrate your daily focus with a grand castle ball.',
    actionType: 'claim_direct',
  },
  forge: {
    title: 'The Fire-Sprite’s Temper',
    subtitle: 'A Fiery Chimney Guest',
    characterName: 'Ignisio',
    characterRole: 'Forge Ember Sprite',
    avatarImg: '/images/creatures/Embera.webp',
    heroImg: '/images/headers/daily-hub-hero.webp',
    themeColor: 'from-red-900/80 via-zinc-950 to-zinc-950 border-red-500/40',
    badgeText: 'Forge Encounter',
    description: 'Your continuous hammering woke up Ignisio from the furnace! Noticing your work at the blacksmith anvil, the sprite offers to inspect your gear.',
  ...
  harvest: {
    ...
    heroImg: '/images/headers/kingdom-header.webp',
  ...
  login: {
    ...
    avatarImg: '/images/encounters/riddle-sage.webp',
    heroImg: '/images/headers/daily-hub-hero.webp',
  ...
  feed: {
    ...
    heroImg: '/images/headers/character-header.webp',
