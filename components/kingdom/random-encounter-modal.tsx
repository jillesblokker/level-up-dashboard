...
const ENCOUNTER_DATA: Record<EncounterType, EncounterData> = {
  meditation: {
    ...
    description: 'To rebuild Castle Valoreth, one must first master the storm within. Close your eyes, breathe deeply, and let your spirit center for 10 seconds to restore clarity.',
  ...
  quest_completion: {
    ...
    description: 'News of your rebuilt town reached the Sunspire Empire! Queen Valandriel arrives with her Iron Peaks vanguard to celebrate your daily habit focus with royal honors.',
  ...
  forge: {
    ...
    description: 'Your continuous discipline at the forge woke up Ignisio from the embers! The sprite inspects your gear, marveling at how consistent daily effort strengthens metal and spirit alike.',
  ...
  harvest: {
    ...
    description: 'A glowing Harvest Elk steps into your restored farmland. Returning citizens bow in reverence as Ether energy generated by your completed habits surges through the soil!',
    actionType: 'claim_direct',
  },
  login: {
    ...
    description: 'Safe inside Thrivehaven’s reconstructed trade road, Barnaby unloads a chest of ancient citadel blueprints to reward your daily return.',
  ...
  feed: {
    ...
    description: 'A playful dungeon slime drops from above and gobbles up the botanical treat! Burping happily, it spits out an ancient relic lost when the dark mist first fell.',
    actionType: 'claim_direct',
  },
};
