...
const ENCOUNTER_DATA: Record<EncounterType, EncounterData> = {
  meditation: {
    ...
    descriptions: [
      'To rebuild Castle Valoreth, one must first master the storm within. Close your eyes, breathe deeply, and let your spirit center for 10 seconds to restore clarity.',
      'The tall pine bends with winter winds without snapping. Allow your racing thoughts to settle like autumn leaves falling onto still water.',
      'Wisdom is not found in endless rushing, but in quiet presence. Pause for a breath, listen to the kingdom breeze, and find your center.',
      'True mastery of the mind mirrors the mountain spring: steady, untroubled by pebbles, and carving valleys through quiet persistence.'
    ],
  ...
  quest_completion: {
    ...
    descriptions: [
      'News of your rebuilt town reached the Sunspire Empire! Queen Valandriel arrives with her Iron Peaks vanguard to celebrate your daily habit focus with royal honors.',
      'A sovereign leads not by decrees, but by personal example. The Sunspire banners salute your relentless discipline and daily diligence.',
      'Your citadel stands as a beacon across the frontier. Queen Valandriel personally bestows imperial commendations upon your kingdom’s hard work.',
      'Where chaos once ruled the mist, your steady daily habits have built a thriving civilization. Accept this royal bounty as proof of our alliance.'
    ],
  ...
  forge: {
    ...
    descriptions: [
      'Your continuous discipline at the forge woke up Ignisio from the embers! The sprite inspects your gear, marveling at how consistent daily effort strengthens metal and spirit alike.',
      'Crackling sparks dance around your anvil! Ignisio blows a hot ember breath across your tools, tempering them with magical heat.',
      'Cold iron yields to stubborn fire! Ignisio cackles with glee as your discipline keeps the royal furnaces glowing white-hot.',
      'Consistency is the hammer, habit is the anvil! Ignisio leaves a trail of fiery footprints as he blesses your latest craftsmanship.'
    ],
  ...
  harvest: {
    ...
    descriptions: [
      'A glowing Harvest Elk steps into your restored farmland. Returning citizens bow in reverence as Ether energy generated by your completed habits surges through the soil!',
      'Deep beneath the cobblestones, the mycorrhizal network hums with life. Seqoio watches over your flourishing crops with gentle ancient pride.',
      'The soil remembers every honest hour of toil. Golden grain waves in the wind as Seqoio channels nature’s abundance into your granaries.',
      'As your daily habits root into life, the forest responds in kind. Rare medicinal sprouts and emerald clover bloom along your settlement borders.'
    ],
    actionType: 'claim_direct',
  },
  login: {
    ...
    descriptions: [
      'Safe inside Thrivehaven’s reconstructed trade road, Barnaby unloads a chest of ancient citadel blueprints to reward your daily return.',
      'Wagon wheels greased and ledgers balanced! Barnaby tips his feathered cap and reveals rare curio cards collected from distant ports.',
      'The trade winds blow fortune toward those who show up every day! Barnaby shares rare architectural blueprints salvaged from ancient ruins.',
      'Another day, another profitable arrival! Barnaby has cataloged rumors of ancient dungeons and brings trade goods to celebrate your momentum.'
    ],
  ...
  feed: {
    ...
    descriptions: [
      'A playful dungeon slime drops from above and gobbles up the botanical treat! Burping happily, it spits out an ancient relic lost when the dark mist first fell.',
      'Buldour wiggles with pure joy! Churning through granite pebbles and morning treats, it unearths shiny tokens buried beneath the flagstones.',
      'Squish, squish! Buldour bounces enthusiastically across the square, leaving a trail of polished river stones and surprise goodies behind.',
      'A heavy thud announces Buldour’s landing! The cheerful creature spits out a sparkling crystal shard with a contented, rumbling gurgle.'
    ],
    actionType: 'claim_direct',
  },
};
        ...
        <div className="p-6 space-y-6">
          <p className="text-xs text-zinc-300 leading-relaxed bg-zinc-950/60 p-3.5 rounded-xl border border-white/5 font-serif italic">
            &quot;{data.descriptions && data.descriptions.length > 0
              ? data.descriptions[(typeof window !== 'undefined' ? (new Date().getDate() + new Date().getDay()) : 0) % data.descriptions.length]
              : data.description}&quot;
          </p>
