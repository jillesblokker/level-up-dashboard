                ...
                <div className="p-6">
                    ...
                    <div className="grid w-full grid-cols-6 mb-6 gap-2">
                        {Array.from({ length: 6 }).map((_, i) => (
                            <Skeleton key={i} className="h-10 bg-zinc-800/50" />
                        ))}
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {Array.from({ length: 9 }).map((_, i) => (
                            <div key={i} className="border border-zinc-800/50 rounded-lg bg-zinc-900 p-4 flex gap-4 animate-pulse">
                                <Skeleton className="w-16 h-16 rounded-lg shrink-0 bg-zinc-800" />
