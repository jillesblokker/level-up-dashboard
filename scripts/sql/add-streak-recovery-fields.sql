-- ==========================================
-- ADD STREAK RECOVERY FIELDS
-- Migration to add streak recovery and failure mitigation features
-- ==========================================
...
SET max_streak_achieved = GREATEST(streak_days, max_streak_achieved)
WHERE max_streak_achieved < streak_days;
...
WHERE table_schema = 'public' 
  ...
  AND column_name IN ('resilience_points', 'safety_net_used', 'missed_days_this_week', 'last_missed_date', 'consecutive_weeks_completed', 'streak_broken_date', 'max_streak_achieved')
