...
export class MapGenerator {
  ...
  private createTile(x: number, y: number, type: TileType): Tile {
    ...
    const tileDescriptions: Record<string, string> = {
      ...
      waterway_canal: 'A serene waterway canal with clear running waters and an arched stone bridge',
    ...
    const tileImages: Record<string, string> = {
      ...
      farm: '/images/kingdom-tiles/Vegetables.webp',
      lumber_mill: '/images/kingdom-tiles/Sawmill.webp',
      market: '/images/kingdom-tiles/MarketStalls.webp',
      cottage: '/images/kingdom-tiles/House.webp',
      ...
      'daily-hub': '/images/kingdom-tiles/Dailyhub.webp',
