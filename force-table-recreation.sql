-- Force Table Recreation Script
-- This script aggressively drops and recreates tables to fix the UUID/TEXT issues
-- Run this in your Supabase SQL editor

-- First, disable RLS temporarily to avoid policy conflicts
ALTER TABLE IF EXISTS quest_favorites DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS kingdom_grid DISABLE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS tile_placements DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS monster_spawns DISABLE ROW LEVEL SECURITY;
...
-- Drop all constraints that might exist
DO $$
BEGIN
    -- Drop all possible constraint names for quest_favorites
    ...
    ALTER TABLE IF EXISTS quest_favorites DROP CONSTRAINT IF EXISTS quest_favorites_pkey;
    
    -- Drop all possible constraint names for kingdom_grid
    ...
    ALTER TABLE IF EXISTS kingdom_grid DROP CONSTRAINT IF EXISTS kingdom_grid_pkey;
    
    -- Drop all possible constraint names for user_progress
    ...
    ALTER TABLE IF EXISTS user_progress DROP CONSTRAINT IF EXISTS user_progress_pkey;
    
    -- Drop all possible constraint names for achievements
    ...
    ALTER TABLE IF EXISTS achievements DROP CONSTRAINT IF EXISTS achievements_pkey;
    
    -- Drop all possible constraint names for tile_placements
    ...
    ALTER TABLE IF EXISTS tile_placements DROP CONSTRAINT IF EXISTS tile_placements_pkey;
    
    -- Drop all possible constraint names for monster_spawns
    ALTER TABLE IF EXISTS monster_spawns DROP CONSTRAINT IF EXISTS monster_spawns_pkey;
...
-- Force drop tables with CASCADE to remove all dependencies
...
-- Create quest_favorites table with correct structure
...
-- Create kingdom_grid table with correct structure
...
-- Create tile_placements table with correct structure
