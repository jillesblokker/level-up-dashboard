...
export default function NotificationsPage() {
  ...
  const EmptyState = ({ title, message, description, showMailbox = true }: {
    ...
    <div className="w-full min-h-[80vh] flex flex-col items-center justify-center relative overflow-hidden bg-black rounded-xl border border-amber-800/20 shadow-lg">
      ...
      <div className="absolute inset-0 bg-[url('/images/headers/kingdom-header.webp')] bg-cover bg-center opacity-5" />
  ...
  return (
    <div className="flex min-h-screen flex-col bg-black text-white">
      ...
      <main className="flex-1 p-4 md:p-6 space-y-6 pt-[max(1.25rem,env(safe-area-inset-top))] pt-safe pb-28 pb-safe md:pb-12">
        {/* Enhanced Header */}
