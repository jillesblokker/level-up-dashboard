  ...
  return (
    <div className={cn(
      ...
      <HeaderSection
        ...
        subtitle={isVisiting ? `${allyProfile ? getCurrentTitle(allyProfile.level).name : 'Squire'} • Level ${allyProfile?.level || 1}` : `${getCurrentTitle(playerLevel).name} • Level ${playerLevel} — Build out your capital. Construct properties, collect taxes from the properties, and expand your kingdom!`}
