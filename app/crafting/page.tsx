...
import { Flame, Sparkles, AlertTriangle, ArrowLeft, Plus, RefreshCw, Layers, Shield, Zap } from "lucide-react"
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-7 flex flex-col space-y-6">
              ...
              {/* CAULDRON CARD */}
              <Card className="bg-zinc-900/40 backdrop-blur-md border border-white/5 shadow-2xl relative overflow-hidden rounded-3xl">
              ...
              {/* COMPANION PET PANEL */}
              {guardian && (
                <div className="p-4 bg-zinc-900/40 backdrop-blur-md border border-white/5 rounded-3xl flex items-center gap-4 relative">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="relative mt-1 bg-zinc-950 border border-white/5 p-3 rounded-2xl text-xs font-serif italic text-zinc-300">
                      <div className="absolute left-4 -top-1.5 w-3 h-3 bg-zinc-950 border-l border-t border-white/5 transform rotate-45" />
            ...
            <div className="lg:col-span-5 flex flex-col space-y-6">
              ...
              <Card className="bg-zinc-900/40 backdrop-blur-md border border-white/5 shadow-2xl rounded-3xl">
                <CardHeader className="border-b border-white/5 pb-4">
                    ...
                    {inventory.filter(i => i.id.startsWith('material-')).map(item => {
                      ...
                      return (
                        <div
                          ...
                          className={`p-3 bg-zinc-950 border rounded-2xl flex items-center justify-between cursor-pointer transition-all ${
                            availableQty > 0
                              ? "border-white/5 hover:border-purple-500/40 hover:bg-zinc-900/50"
                        ...
                        >
                          ...
                          <Badge className="bg-zinc-900 text-zinc-300 font-extrabold text-xs">
                            {availableQty}
                          </Badge>
                        </div>
                      )
                  ...
                  {RECIPES.map(recipe => {
                    return (
                      <div
                        ...
                        className="p-3.5 bg-zinc-950/80 border border-white/5 hover:border-purple-500/30 rounded-2xl transition-all cursor-pointer group"
                      >
                ...
                <CardContent className="p-4 space-y-2.5">
                  {activeModifiers.map((mod, idx) => (
                    <div key={idx} className="p-3 bg-zinc-950 border border-white/5 rounded-2xl flex items-center justify-between">
                      ...
                      <Badge className="bg-zinc-900 text-zinc-500 text-[10px] border border-white/5">
