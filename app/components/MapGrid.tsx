...
const getTileImage = (tileType: string) => {
  ...
  switch (tileType) {
    ...
    case 'pyramid': return '/images/tiles/pyramid-tile.webp';
    case 'whispering-well': return '/images/tiles/whispering-well-tile.webp';
    case 'sphinx-gates': return '/images/tiles/sphinx-gates-tile.webp';
    case 'whispering-canopy': return '/images/tiles/whispering-canopy-tile.webp';
    case 'frostfire-obelisk': return '/images/tiles/frostfire-obelisk-tile.webp';
    case 'fairy-ring': return '/images/tiles/fairy-ring-tile.webp';
    case 'settlement': return '/images/tiles/settlement-tile.webp';
    case 'megapolis': return '/images/tiles/megapolis-tile.webp';
    case 'prison': return '/images/tiles/prison-tile.webp';
    case 'apotheca': return '/images/tiles/apotheca-tile.webp';
    case 'abbey': return '/images/tiles/abbey-tile.webp';
      ...
      >
        ...
        {isPenguinPresent && penguinPos && !penguinCaught && (
          <div
            onClick={(e) => {
              e.stopPropagation();
              window.dispatchEvent(new CustomEvent('open-animal-interaction', { detail: { animalType: 'penguin', animalName: 'Penguino' } }));
            }}
