...
import { ArrowLeft, Check, Clock, Coins, Shield, Sword, Trophy, Users, X } from "lucide-react"
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 p-4 md:p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold tracking-tight font-serif">Rivals & Challenges</h1>
            <p className="text-muted-foreground">Compete with friends to stay motivated</p>
          </div>
          <Link href="/">
        ...
        <div className="space-y-6">
          <Tabs defaultValue="challenges" className="w-full">
            ...
            <TabsContent value="challenges" className="space-y-4 mt-4">
              <div className="flex justify-between items-center">
                ...
                <Button
                  ...
                  onClick={() => openNewChallengeDialog(rivals[0])}
                >
                  <Sword className="mr-2 h-4 w-4" />
                  New Challenge
                </Button>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                {challenges
                  ...
                  .map((challenge) => (
                    <Card key={challenge.id} className="medieval-card">
                      <CardHeader>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                {challenges
                  ...
                  .map((challenge) => (
                    <Card
                      key={challenge.id}
                      className={`medieval-card ${challenge.status === "won" ? "border-green-500" : "border-red-500"}`}
                    >
                      <CardHeader>
                        <div className="flex justify-between items-start">
                          <CardTitle className="font-serif">{challenge.title}</CardTitle>
            ...
            <TabsContent value="rivals" className="space-y-4 mt-4">
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {rivals
                  ...
                  .map((rival) => (
                    <Card key={rival.id} className="medieval-card">
                      <CardHeader>
                ...
                {rivals.filter((rival) => rival.status === "active").length === 0 && (
                  <div className="col-span-full text-center py-12 bg-amber-50/30 dark:bg-amber-900/10 rounded-lg border border-amber-200 dark:border-amber-800">
                    ...
                    <Button variant="outline">Find Rivals</Button>
                  </div>
                )}
              </div>
            </TabsContent>
            ...
            <TabsContent value="requests" className="space-y-4 mt-4">
              <h2 className="text-xl font-bold font-serif">Rival Requests</h2>

              <div className="grid gap-6 md:grid-cols-2">
                {rivals
                  .filter((rival) => rival.status === "pending")
                  .map((rival) => (
                    <Card key={rival.id} className="medieval-card">
                      <CardHeader>
                        <div className="flex items-center gap-4">
                      ...
                      <CardFooter>
                        <div className="w-full flex gap-2">
                          ...
                          <Button variant="outline" className="flex-1" onClick={() => declineRivalRequest(rival.id)}>
                ...
                {rivals.filter((rival) => rival.status === "pending").length === 0 && (
                  <div className="col-span-2 text-center py-12 bg-amber-50/30 dark:bg-amber-900/10 rounded-lg border border-amber-200 dark:border-amber-800">
